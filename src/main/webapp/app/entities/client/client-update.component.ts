...
export class ClientUpdateComponent implements OnInit {
  ...
  updateForm(client: IClient) {
    this.editForm.patchValue({
      ...
      name: client.name,
      logo: client.logo,
      dueDateUnit: client.dueDateUnit,
      dueDateValue: client.dueDateValue,
  ...
  private createFromForm(): IClient {
    return {
      ...
      dueDateUnit: this.editForm.get(['dueDateUnit']).value,
      dueDateValue: this.editForm.get(['dueDateValue']).value,
