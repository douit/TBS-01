...
public class EventPublisherService {
    ...
    public TBSEventRespDTO<RefundDTO> createNewRefund(TBSEventReqDTO<RefundDTO> eventReq, Invoice invoice, Optional<Payment> payment) throws IOException, JSONException {
